...
describe('Avatar', () => {
  it('renders correctly with image', () => {
    ...
    expect(avatarRoot).toHaveClass('relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full');
  ...
  it('applies custom classes to AvatarImage', () => {
    ...
    const { container } = render(
      <Avatar>
        <AvatarImage src="/test-image.png" alt="Test User" className="image-class" />
        <AvatarFallback>TU</AvatarFallback>
      </Avatar>
    );
