...
const mockMediumMatch = {
    ...
    analysis: {
        ...
        overallScore: 65,
        technicalSkillsMatch: {
            ...mockMatch.analysis.technicalSkillsMatch,
            score: 65,
        },
...
describe("JobMatchCard", () => {
    ...
    it("renders the analysis summary when provided", () => {
        ...
        expect(
            screen.getByText(
                "Strong technical skills match with relevant experience",
            ),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when analysis summary is empty", () => {
        ...
        expect(
            screen.getByText("No detailed analysis available."),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when no key highlights are available", () => {
        render(<JobMatchCard match={mockEmptyMatch} />);
        expect(
            screen.getByText("No key highlights identified."),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when no key gaps are available", () => {
        render(<JobMatchCard match={mockEmptyMatch} />);
        expect(
            screen.getByText("No significant gaps identified."),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when no matching technical skills are available", () => {
        render(<JobMatchCard match={mockEmptyMatch} />);
        expect(
            screen.getByText("No matching technical skills found."),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when no missing technical skills are available", () => {
        render(<JobMatchCard match={mockEmptyMatch} />);
        expect(
            screen.getByText("No missing technical skills identified."),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when no matching soft skills are available", () => {
        render(<JobMatchCard match={mockEmptyMatch} />);
        expect(
            screen.getByText("No matching soft skills found."),
        ).toBeInTheDocument();
    });
    ...
    it("shows fallback text when no missing soft skills are available", () => {
        render(<JobMatchCard match={mockEmptyMatch} />);
        expect(
            screen.getByText("No missing soft skills identified."),
        ).toBeInTheDocument();
    });
    ...
    it("displays experience match information", () => {
        render(<JobMatchCard match={mockMatch} />);
        expect(
            screen.getByText("5 years of relevant experience"),
        ).toBeInTheDocument();
        ...
        expect(
            screen.getByText("No experience with cloud platforms"),
        ).toBeInTheDocument();
    });
    ...
    it("displays education match information", () => {
        render(<JobMatchCard match={mockMatch} />);
        expect(
            screen.getByText("Bachelor degree in Computer Science"),
        ).toBeInTheDocument();
        // Use getAllByText and select the second occurrence of 'Gaps:'
        const gapsTexts = screen.getAllByText(/Gaps:/i);
        expect(gapsTexts[1]).toBeInTheDocument();
        expect(
            screen.getByText("No specialized certifications"),
        ).toBeInTheDocument();
    });
