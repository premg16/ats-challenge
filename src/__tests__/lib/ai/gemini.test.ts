...
describe("Gemini", () => {
    ...
    const mockJsonResponse = {
        answer: "AI is a technology that enables machines to mimic human intelligence",
    };
    ...
    beforeEach(() => {
        ...
        (SystemMessage as unknown as jest.Mock).mockImplementation((text) => ({
            text,
            type: "system",
        }));
        (HumanMessage as unknown as jest.Mock).mockImplementation((text) => ({
            text,
            type: "human",
        }));
    });
