            ...
            jobMatches: [
              {
                ...
                analysis: {
                  overallScore: 85,
                  justification: "Strong match for technical skills",
                  ...
                  experienceMatch: {
                    score: 85,
                    matching: "3 years of frontend development",
                    gaps: "No leadership roles"
                  },
                  educationMatch: {
                    score: 90,
                    matching: "Relevant degree in Computer Science",
              ...
              experience: [
                {
                  ...
                  responsibilities: ["Managed product roadmap"],
                  achievements: ["Launched 5 successful features"]
                }
              ],
              education: [
                {
